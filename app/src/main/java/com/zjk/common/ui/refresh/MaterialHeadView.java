...
public class MaterialHeadView extends FrameLayout implements MaterialHeadListener {
    ...
    private OnHeadViewOnAttachToWindowListener mOnAttachListener;
    ...
    public void setOnAttatchListener (OnHeadViewOnAttachToWindowListener listener) {
...
//    }
    ...
    public interface OnHeadViewOnAttachToWindowListener {
